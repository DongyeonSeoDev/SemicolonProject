...
public class Player : MonoBehaviour
{
    ...
    {
        PlayerEnemyUnderstandingRateManager.Instance.SetDrainProbabilityDict(objId, PlayerEnemyUnderstandingRateManager.Instance.GetDrainProbabilityDict(objId) + upMountingPercentageValueWhenEnemyDead);
