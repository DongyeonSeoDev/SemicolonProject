...
public class EffectManager : MonoSingleton<EffectManager>
{
    ...
    public void OnDamaged(float damage, bool critical, bool isEnemy, Vector2 pos, Vector2 effectPosition, Vector2 direction, Vector3? effectSize = null) //When monster or player receive damage, Shows damage text effect UI.
    {
